...
/**
 * 
 * This class will test the Dots and Boxes engine. It will test the methods used
 * to manage a two-player game of Dots And Boxes. The game is played on a matrix
 * pattern of dots, with each dot representing one vertex of a grid of
...
public class DABGameTest {
	...
	/*
	 * Test the size of the box grid to be at least 2*2. It throws an exception if
	 * it fails
	 */
	@Test
	...
	/*
	 * Initialize the board and draw edge at the null direction and capture the
	 * exception.
	 */
	@Test(expected = GameException.class)
	...
	public void testDrawFirstEdge() {
		...
		assertTrue(dab.getDrawnEdgesAt(new Coordinate(0, 0).getNeighbor(Direction.EAST)).contains(Direction.WEST));
	}
	...
	/*
	 * Test the full game engine at 2 by 2 grid size in total of four boxes.
	 * Observed the score and noticed the winner.
	 */
	@Test
