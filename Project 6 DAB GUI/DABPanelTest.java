...
public class DABPanelTest {
	...
	/**
	 * 
	 * Ensure the score labels contain only the expected number, with no other
	 * digits.
	 * 
	 * @param expectP1
	 *            expected score of Player.ONE
	 * 
	 * @param expectP2
	 *            expected score of Player.TWO
	 * 
	 */
	 ...
	 * 
	 * 
	 * Draw an edge by setting the combo boxes and simulating a click of the draw
	 * button. This must all be done within the context of Swing, so we must use a
	 * utility to ask Swing to schedule the task, then wait until it has been
	 * completed to continue testing.
	 *
	 * 
	 * @param x
	 *            coordinate x
	 ...
	 *
	 * This must all be done within the context of Swing, so we must use a utility
	 * to ask Swing to schedule the task, then wait until it has been completed to
	 * continue testing.
	 *
	 * 
	 * @param item
	 ...
	 * 
	 * @param <T>
	 *            Type of component expected to be returned, when it can be inferred
	 *            by compiler
	 * 
	 * @param root
	 *            top-level container to search
	 * 
	 * @param name
	 ...
	 * 
	 * NOTE: This method will very briefly display the entire interface at its
	 * normal size.
	 * 
	 * ACADEMIC NOTE: This is only to achieve for 100% coverage; it serves no other
	 * useful purpose.
	 * 
	 * 
	 */
