...
public class DABPanel extends JPanel {
	...
	public DABPanel(JFrame frame) {
		...
		// TODO: use a method reference to add handleDrawButton() as a listener to the
		// draw button
	...
	private void updateStatus() {
		// TODO: read the game status via accessors; set each label component's text
		// accordingly
	...
	private JMenuBar setupMenuBar() {
		...
		// clicked
		// TODO: use lambda expressions to handle activating and deactivating
		// interactive mode
