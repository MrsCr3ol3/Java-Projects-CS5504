  ...
  *  This Class is used to eat eatable objects in room. In order to eat the object must be carried.
 
  *  Once eaten the objecs will be removed from inventory and room.
