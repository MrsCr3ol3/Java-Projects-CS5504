  ...
  public void testInit()  
{
 ...
 public void testEmptyDescriptionWithAnExamine()
 {
     executeMoves();
     assertEquals(
         "You don't see anything special about the ruby.",
         Message.examineDefaultMessage("ruby"));
     executeMoves("i");
     assertEquals(Message.inventoryEmptyMessage(), message);
     executeMoves("go", "n", "n");
     executeMoves("go south");
 ...
 public void testInitialStageToTheFinalStageWithAllPossibleTestCases()
     ...
     executeMoves("go south");
     assertEquals(
         "You don't want to go to fitness center without reading a  soccer-training-book.",
         message);
     ...
     assertEquals(
         "you read soccer training book, now you can go south to fitness center.",
         message);
     ...
     executeMoves("i");
     assertEquals(
         "<p>You are holding the ruby, the soccer-training-book and the soccer-ball.</p>",
         message);
     executeMoves("s");
     executeMoves("take soccer-ball");
     ...
     executeMoves("shoot soccer-ball");
     assertEquals(
         "You shot the soccer ball into the net. You score a goal, Congratulations. You won!",
         message);
 }
