...
/**
 * 
 * This Class inherits from Command class. This class is used to drink drinkable
 * objects. This class is used by executing the execute method on item.
 * 
 * @author Jeevan Thapa
 * 
 * @version Nov 19, 2017
...

{
	...
	public String execute(Player playerArg) {
		...
		if (room.hasItem(secondWord)) {
			return "You need to take the " + secondWord + " in order to drink it.";
		}
