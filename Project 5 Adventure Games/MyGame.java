  ...
  * This MyGame class defines the new commands used to command on the object.This class also creates
  
  * and describe room objects in different direction.This class sets the map or route for the player
  
  * to follow during the game. This class also define different objects in different rooms. This
  
  * class not only sets the properties of objects, but also add certain items to the room at initial.
 ...
 public void createRooms()
 {
     ...
     Item soccerTraningBook = new Item(
         "soccer-training-book",
         "you need to read the soccer training book before you leave.");
     Item soccerBall = new Item(
         "soccer-ball",
         "you need to drop the soccer ball "
             + ", drop the soccer-training-book and shoot the soccer-ball"
