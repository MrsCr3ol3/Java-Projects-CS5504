...
/**
 * 
 * Message file for the adventure game. These methods generate standardized
 * messages that should be used whenever applicable for compatibility with the
 * automated grading system. You may add new messages to this file, but please
 * don't modify any of the existing message.
 * 
 * @author Dr. K
 * 
 * @version 1.2
...
public class Message {
	...
	/**
	 * Initialization of game from living room.
	 * 
	 * @return String living room
	 */
	public static final String livingRoomDescriptionMessage() {
		return "in your living room";
	}
	...
	/**
	 * Message shown when a command is requested on an object, but the object is
	 * neither in your inventory nor in the room. It may or may not exist elsewhere
	 * in the game world.
	 * 
	 * @param objName
	...
	/**
	 * Message you get when you don't have enough room in your inventory. In other
	 * words, taking something would result in carrying too much weight.
	 * 
	 * @param objName
	 *            second word in command
