...
/**
 * 
 * This Class extends the Command class. This class is used to lock any lockable
 * objects in the room. Player needs to take the item before they lock it.
 * Player also needds to drop the item if they are holding it. it represents,
 * and how to use it.
 * 
 * @author Jeevan Thapa
 * 
