package adventure;
  ...
  * This class is used to drop objects from the hand or inventory. Once dropped the objects will be
  
  * removed from the inventory. The main purpose of this class is to add item in rooms from
 ...
 public String execute(Player playerArg)
 {
     ...
     if (!hasSecondWord())
     {
         return "The drop command requires an object in your inventory to "
             + "drop.";
     }
